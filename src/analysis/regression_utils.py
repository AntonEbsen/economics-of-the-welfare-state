...
LATEX_LABEL_MAP = {
    ...
    "KOFIpGIdf\\_lag1": "Interpersonal, de facto$_{t-1}$",
    "KOFIpGIdj\\_lag1": "Interpersonal, de jure$_{t-1}$",
    "KOFInGI\\_lag1": "Globalization (Informational)$_{t-1}$",
    "KOFInGIdf\\_lag1": "Informational, de facto$_{t-1}$",
    "KOFInGIdj\\_lag1": "Informational, de jure$_{t-1}$",
    "KOFCuGI\\_lag1": "Globalization (Cultural)$_{t-1}$",
    "KOFCuGIdf\\_lag1": "Cultural, de facto$_{t-1}$",
    "KOFCuGIdj\\_lag1": "Cultural, de jure$_{t-1}$",
