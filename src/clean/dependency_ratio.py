...
def standardize_dependency_to_long(df_raw: pd.DataFrame) -> pd.DataFrame:
    ...
    # Clean dependency ratio values
    df_long["dependency_ratio"] = pd.to_numeric(df_long["dependency_ratio"], errors="coerce")
    ...
    return df_long[["country", "year", "dependency_ratio"]]
