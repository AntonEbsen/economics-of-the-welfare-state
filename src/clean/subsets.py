...
COUNTRY_GROUPS = {
    ...
    "eastern_europe": {"BGR", "CZE", "EST", "HUN", "LVA", "LTU", "POL", "SVK", "SVN"},
    "anglo": {"USA", "GBR", "CAN", "AUS", "NZL"},
    "nordic": {"DNK", "FIN", "ISL", "NOR", "SWE"},
    "eu_founders": {"BEL", "FRA", "DEU", "ITA", "LUX", "NLD"},
    "post_communist": {"BGR", "CZE", "EST", "HUN", "LVA", "LTU", "POL", "SVK", "SVN"},
}
